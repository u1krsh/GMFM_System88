                ...
                self.list.controls.append(
                    ft.Container(
                        content=ft.Row([
                            ...
                            ft.Container(
                                content=ft.Icon("edit", color=PRIMARY, size=20),
                                width=40, height=40,
                                border_radius=10,
                                bgcolor=f"{PRIMARY}20",
                                alignment=ft.alignment.center,
                                tooltip="Continue/Edit",
                                on_click=lambda _, sid=s.id, stud_id=self.student_id, scale=s.scale: self._page_ref.go(f"/scoring?student_id={stud_id}&session_id={sid}&scale={scale}"),
                            ),
